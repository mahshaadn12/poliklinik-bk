    ...
    if ($password === $confirm_password) {
        ...
        if ($result->num_rows == 0) {
            ...
            if (mysqli_query($mysqli, $insert_query)) {
                ...
                document.location='index.php?page=login_pasien';
                </script>";
            } else {
                ...
                <div class="card-body">
                    <form method="POST" action="index.php?page=registerUser">
                        ...
                        <div class="form-group">
                            ...
                            <input type="varchar" name="alamat" class="form-control" required placeholder="Masukkan alamat anda">
                        </div>
                        <div class="form-group">
                            <label for="no-ktp">No KTP</label>
                            <input type="varchar" name="no_ktp" class="form-control" required placeholder="Masukkan nama anda">
                        </div>
                    ...
                    <div class="text-center">
                        <p class="mt-3">Sudah Punya Akun? <a href="index.php?page=login_pasien">Login</a></p>
                    </div>
                </div>
            </div>
        </div>
