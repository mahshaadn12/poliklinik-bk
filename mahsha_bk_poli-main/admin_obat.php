...
if (isset($_POST['simpan'])) {
    ...
    echo "<script> 
                document.location='index_admin.php?page=admin_obat';
                </script>";
}
if (isset($_GET['aksi'])) {
    if ($_GET['aksi'] == 'hapus') {
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-success rounded-pill px-3" href="index_admin.php?page=admin_obat&id=<?php echo $data['id'] ?>">Ubah</a>
                        <a class="btn btn-danger rounded-pill px-3" href="index_admin.php?page=admin_obat&id=<?php echo $data['id'] ?>&aksi=hapus">Hapus</a>
                    </td>
                </tr>
            <?php
            }
