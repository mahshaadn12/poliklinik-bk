...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Poliklinik Anugerah Jaya</a>
            ...
            <?php
                ...
                ?>
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="logout_pasien.php">Logout (<?php echo $_SESSION['username'] ?>)</a>
                        </li>
                    </ul>
                <?php
                } else {
                ...
                ?>
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Login Sebagai</a>
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="index.php?page=login_admin">Admin</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="index.php?page=login_pasien">Pasien</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="index.php?page=login_dokter">Dokter</a>
                        </li>
                    </ul>
                </li>
                    </ul>
